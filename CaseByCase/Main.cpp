...
=======
>>>>>>> e2b6bfa59003ede9bef4095c753fa2194d93fd97
...
=======
	...
	addtxt(1, com[1].getFile(1), "public", "딹뛀꼘뿔2", "1", true);
	addtxt(1, com[1].getFile(1), "public", "딹뛀꼘뿔3", "1", true);     // 2번 컴퓨터에 딹뛀꼘뿔 이라는 폴더을 생성 \ 그다음에 파일안에서 비밀번호
	addtxt(1, com[1].getFile(1), "public", "딹뛀꼘뿔4", "2", true);
	addtxt(1, com[1].getFile(1), "public", "딹뛀꼘뿔5", "5", true);
>>>>>>> e2b6bfa59003ede9bef4095c753fa2194d93fd97
...
=======
	addFol(3, nullptr, "public", "형의_스마트폰", true); setPass("나의 생일");
